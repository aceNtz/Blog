...
<head>
  ...
  <title>Blog - Blog Post Form</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Blog Post Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form:hidden path="viewCount"/>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" placeholder="Add description" path="description"/>
                  </div>
                  <div class="form-group">
                    <label>Tekst bloga</label>
                    TODO
                  </div>
                  <div class="form-group">
                    <label>Tags</label>
