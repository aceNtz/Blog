                  ...
                  <c:forEach items="${blogPostList }" var="blogPost">
	                  <tbody id="sort-list">
	                    <tr>
	                      ...
	                      <td class="text-center">${blogPost.name }</td>
	                      <td class="text-center"><img src="${blogPost.image }" style="max-width: 80px;"></td>
	                      <td class="text-center">${blogPost.author.username }</td>
	                      <td class="text-center">${blogPost.category.name }</td>
	                      <td class="text-center">${blogPost.date }</td>
	                      <td class="text-center">${blogPost.enabled == true ? 'YES' : 'NO'}</td>
	                      <td class="text-center">${blogPost.important == true ? 'YES' : 'NO'}</td>
	                      <td class="text-center">${blogPost.viewCount }</td>
	                      <td class="text-center">${blogPost.comments.size() }</td>
	                      <td class="text-center">
	                        <div class="btn-group">
	                          <a href="blog-post-important-update?id=${blogPost.id }" class="btn btn-info">
	                            <i class="${blogPost.important == false ? 'fas fa-star' : 'far fa-star-half'}"></i>
	                          </a>
	                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-modal-${blogPost.id }">
	                            <i class="fas fa-trash"></i>
	                          </button>
	                        </div>
	                      </td>
	                    </tr>
	                    <div class="modal fade" id="delete-modal-${blogPost.id }">
					      <div class="modal-dialog">
					        <div class="modal-content">
					          ...
					          <div class="modal-footer justify-content-between">
					            ...
					            <a href="blog-post-delete?id=${blogPost.id }&pageId=1" class="btn btn-danger">Delete</a>
					          </div>
					        </div>
					        <!-- /.modal-content -->
					      </div>
