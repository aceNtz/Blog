...
<head>
  ...
  <title>Blog - My Blog Posts</title>
                  ...
                  <c:forEach items="${blogPostList }" var="blogPost">
	                  <tbody id="sort-list">
	                    <tr>
	                      ...
	                      <td class="text-center">
	                        <div class="btn-group"> 
	                          <a href="blog-post-update?id=${blogPost.id }" class="btn btn-info">
					      ...
					      <div class="modal-dialog">
					        <div class="modal-content">
					          ...
					          <div class="modal-footer justify-content-between">
					            ...
					            <a href="blog-post-delete?id=${blogPost.id }&pageId=2" class="btn btn-danger">Delete</a>
					          </div>
					        </div>
					        <!-- /.modal-content -->
					      </div>
