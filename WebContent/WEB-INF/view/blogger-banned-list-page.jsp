...
<head>
  ...
  <title>Blog - Banned Bloggers</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Banned bloggers</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Bloggers</a></li>
              <li class="breadcrumb-item active">Banned bloggers</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All banned bloggers</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th class="text-center">Unban blogger</th>
                    </tr>
                  </thead>
                  <c:forEach items="${bannedBloggers }" var="blogger">
	                  <tbody id="sort-list">
	                    <tr>
	                      <td class="text-center">
	                        <strong>${blogger.username }</strong>
	                      </td>
	                      <td class="text-center">
	                        ${blogger.name }
	                      </td>
	                      ...
	                      <td class="text-center">${blogger.authorities }</td>
                      	  <td class="text-center">
                      	  	<a href="blogger-unban?username=${blogger.username }" class="btn btn-warning">
