        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Blogger Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Blogger Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="blogger-save" modelAttribute="blogger" role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" placeholder="Add password" path="password"/>
                  </div>
                  <div class="form-group">
