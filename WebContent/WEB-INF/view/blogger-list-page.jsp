        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Bloggers</a></li>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All bloggers</h3>
                <div class="card-tools">
                  <a href="blogger-form" class="btn btn-success">
                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th class="text-center">Ban blogger</th>
                    </tr>
                  </thead>
                  <c:forEach items="${bloggerList }" var="blogger">
	                  <tbody id="sort-list">
	                    <tr>
	                      ...
	                      <td class="text-center">
	                        <img src="${blogger.image }" style="max-width: 80px;">
	                      </td>
	                      <td class="text-center">${blogger.phone }</td>
	                      <td class="text-center">${blogger.email }</td>
	                      <td class="text-center">${blogger.dateJoined }</td>
	                      <td class="text-center">${blogger.authorities }</td>
	                      <td class="text-center">
                      	  	<a href="blogger-ban?username=${blogger.username }" class="btn btn-danger">
