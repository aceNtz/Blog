...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form:form action="change-password-action" modelAttribute="changePassword" >
        ...
        <div class="input-group mb-3">
          <form:input path="newPassword" type="password" class="form-control" placeholder="New Password"/>
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          <form:input path="confirmPassword" type="password" class="form-control" placeholder="Confirm New Password"/>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
