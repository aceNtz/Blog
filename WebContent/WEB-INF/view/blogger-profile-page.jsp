        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Blogger</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form modelAttribute="blogger" action="blogger-profile-save" role="form">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="color-palette-set">
                 		 <div class="bg-info color-palette"><span>Username: ${blogger.username }</span></div>
                  		 <div class="bg-info disabled color-palette"><span>Date Joined: ${blogger.dateJoined }</span></div>
                      </div>
                      
                      <div class="form-group">
                        <label>Email: (${blogger.email })</label>
                        <form:input path="email"  type="email" class="form-control" placeholder="Enter new email"/>
                      </div>
                      <div class="form-group">
                        <label>Name: (${blogger.name })</label>
                        <form:input path="name" type="text" class="form-control" placeholder="Enter new name"/>
                      </div>
                      <div class="form-group">
                        <label>Surname: (${blogger.surname })</label>
                        <form:input path="surname" type="text" class="form-control" placeholder="Enter new surname"/>
                      </div>
                      <div class="form-group">
                        <label>Phone: (${blogger.phone })</label>
                        <div class="input-group">
                          <form:input path="phone" type="text" class="form-control" placeholder="Enter new phone"/>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <div class="text-center">
                              <img src="${blogger.image }" alt="" class="img-fluid">
                            </div>
                          </div>
                        </div>
                      </div>
