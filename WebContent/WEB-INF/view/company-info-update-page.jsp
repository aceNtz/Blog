...
<head>
  ...
  <title>Blog - Company Info Update</title>
              ...
              <form:hidden path="id"/>
                <div class="card-body">
                  <div class="form-group">
                    <label>Name</label>
                    <form:input type="text" class="form-control" placeholder="Enter new company name" path="name"/>
                  </div>
                  <div class="form-group">
                    <label>City</label>
                    <form:input type="text" class="form-control" placeholder="Enter new city name" path="city"/>
                  </div>
                  <div class="form-group">
                    <label>Street&Number</label>
                    <form:input type="text" class="form-control" placeholder="Add new address" path="StreetAndNumber"/>
                  </div>
                  <div class="form-group">
                    <label>Zip</label>
                    <form:input type="text" class="form-control" placeholder="Enter new zip" path="zipCode"/>
                  </div>
                  <div class="form-group">
                    <label>Phone 1</label>
                    <form:input type="text" class="form-control" placeholder="Enter new phone number" path="phoneOne"/>
                  </div>
                  <div class="form-group">
                    <label>Phone 2</label>
                    <form:input type="text" class="form-control" placeholder="Enter new phone number" path="phoneTwo"/>
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" placeholder="Enter new instagram link" path="instagram"/>
                  </div>
                  <div class="form-group">
                    <label>Facebook</label>
                    <form:input type="text" class="form-control" placeholder="Enter new facebook link" path="facebook"/>
                  </div>
                  <div class="form-group">
                    <label>Twitter</label>
                    <form:input type="text" class="form-control" placeholder="Enter new twitter link" path="twitter"/>
                  </div>
                </div>
                <!-- /.card-body -->
