        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Front text</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Front text</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th class="text-center">Index Intro</th>
                      <th class="text-center">Index text 1</th>
                      <th class="text-center">Index text 2</th>
                      <th class="text-center">Index text 3</th>
                      <th class="text-center">Index text 4</th>
                      <th class="text-center">Latest from blog intro</th>
	                  ...
	                  <tbody id="sort-list">
	                    <tr>
	                      ...
	                      <td>
	                        ${frontText.indexIntro }
	                      </td>
	                      <td>
	                        ${frontText.indexText1 }
	                      </td>
	                      <td>
	                        ${frontText.indexText2 }
	                      </td>
	                      <td>
	                        ${frontText.indexText3 }
	                      </td>
	                      <td>
	                        ${frontText.indexText4 }
	                      </td>
	                      <td>
	                      	${frontText.latestFromTheBlogIntro }
	                      </td>
	                      
	                      <td class="text-center">
	                        <div class="btn-group"> 
	                          <a href="front-text-update" class="btn btn-info">
