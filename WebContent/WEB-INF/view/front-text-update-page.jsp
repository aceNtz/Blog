...
<head>
  ...
  <title>Blog - Front Text Update</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Front Text Update</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Front</a></li>
              <li class="breadcrumb-item active">Front Text Update</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Front Text Update</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="front-text-save" modelAttribute="frontText" role="form">
              <form:hidden path="id"/>
                <div class="card-body">
                  <div class="form-group">
                    <label>Slogan</label>
                    <form:input type="text" class="form-control" placeholder="Enter new slogan" path="slogan"/>
                  </div>
                  <div class="form-group">
                    <label>Index intro</label>
                    <form:input type="text" class="form-control" placeholder="Enter new index intro" path="indexIntro"/>
                  </div>
                  <div class="form-group">
                    <label>Index text 1</label>
                    <form:input type="text" class="form-control" placeholder="Enter new index text" path="indexText1"/>
                  </div>
                  <div class="form-group">
                    <label>Index text 2</label>
                    <form:input type="text" class="form-control" placeholder="Enter new index text" path="indexText2"/>
                  </div>
                  <div class="form-group">
                    <label>Index text 3</label>
                    <form:input type="text" class="form-control" placeholder="Enter new index text" path="indexText3"/>
                  </div>
                  <div class="form-group">
                    <label>Index text 4</label>
                    <form:input type="text" class="form-control" placeholder="Enter new index text" path="indexText4"/>
                  </div>
                  <div class="form-group">
                    <label>Latest from blog intro</label>
                    <form:input type="text" class="form-control" placeholder="Enter new latest from blog intro" path="latestFromTheBlogIntro"/>
                  </div>
                </div>
                <!-- /.card-body -->
