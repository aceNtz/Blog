...
<head>
  ...
  <title>Blog - Slider Element Form</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Slider Element Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Slider</a></li>
              <li class="breadcrumb-item active">Slider Element Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Slider Element Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="slider-element-save" modelAttribute="sliderElement" role="form">
              <form:hidden path="id"/>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Image</label>
                    <form:input type="text" class="form-control" placeholder="Add image" path="image"/>
                    <form:errors path="image" cssClass="text-danger"></form:errors>
                  </div>
                  <div class="form-group">
                    <label>Button Name</label>
                    <form:input type="text" class="form-control" placeholder="Enter button name" path="buttonName"/>
                    <form:errors path="buttonName" cssClass="text-danger"></form:errors>
                  </div>
                  <div class="form-group">
                    <label>Button Url</label>
                    <form:input type="text" class="form-control" placeholder="Add button url" path="buttonUrl"/>
                    <form:errors path="buttonUrl" cssClass="text-danger"></form:errors>
                  </div>
                  <div class="custom-control custom-checkbox">
                    <form:checkbox class="custom-control-input" id="customCheckbox2" path="showInSlider"/>
                    <label for="customCheckbox2" class="custom-control-label">Show as slider Element?</label>
                  </div>
                </div>
                <!-- /.card-body -->
