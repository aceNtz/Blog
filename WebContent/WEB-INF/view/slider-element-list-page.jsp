        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Slider Elements</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Slider Elements</h3>
                <div class="card-tools">
                  <a href="slider-element-form" class="btn btn-success">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <c:forEach items="${sliderElementList }" var="sliderElement">
	                  <tbody id="sort-list">
	                    <tr>
	                      <td class="text-center">
	                        <strong>${sliderElement.id }</strong>
	                      </td>
	                      <td class="text-center">
	                        ${sliderElement.name }
	                      </td>
	                      <td class="text-center">
	                        <img src="${sliderElement.image }" style="max-width: 80px;">
	                      </td>
	                      <td class="text-center">${sliderElement.buttonName }</td>
	                      <td class="text-center">${sliderElement.buttonUrl }</td>
	                      <td class="text-center">${sliderElement.date }</td>
	                      <td class="text-center">${sliderElement.showInSlider == true ? 'YES' : 'NO'}</td>
	                      <td class="text-center">
	                        <div class="btn-group"> 
	                          <a href="slider-element-update?id=${sliderElement.id }" class="btn btn-info">
	                            <i class="fas fa-edit"></i>
	                          </a>
	                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${sliderElement.id }">
	                            <i class="fas fa-trash"></i>
	                          </button>
	                        </div>
	                      </td>
	                    </tr>
	                    <div class="modal fade" id="delete-modal-${sliderElement.id }">
					      <div class="modal-dialog">
					        <div class="modal-content">
					          <div class="modal-header">
					            <h4 class="modal-title">Delete slider element</h4>
					            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					              <span aria-hidden="true">&times;</span>
					            </button>
					          </div>
					          <div class="modal-body">
					            <p>Are you sure you want to delete selected slider element?</p>
					            <strong></strong>
					          </div>
					          <div class="modal-footer justify-content-between">
					            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					            <a href="slider-element-delete?id=${sliderElement.id }" class="btn btn-danger">Delete</a>
					          </div>
					        </div>
					        <!-- /.modal-content -->
					      </div>
